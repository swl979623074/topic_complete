...
public class TopicTask {
	...
	public int closeTopic(){
		String sql_close_topic = "update topic set topi_closed = 1 where topi_id = (select topi_id from (select * from topic) as b where now() > topi_stilltime and topi_closed = 0)";
